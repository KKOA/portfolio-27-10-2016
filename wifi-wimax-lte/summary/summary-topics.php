...
*/ ?>
  ...
  */ ?>
	...
	<main>
		...
		<article>
			<header>
				<h1>Summary Topics</h1>
				<ul>
				<?php $folderUrl = '/wifi-wimax-lte/summary/';?>
					<li><a href="<?php echo $folderUrl;?>wifi-vs-wimax-vs-lte.php">Wi-Fi vs WiMAX vs LTE</a></li>
					<li><a href="<?php echo $folderUrl;?>reports.php">Reports</a></li>
				</ul>
			</header>
			<footer>
