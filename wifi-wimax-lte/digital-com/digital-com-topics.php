...
$title = "Digital Communication Topics";
$author ;
//$author = "Keith Amoah";
if(!isset($date))
{
...
*/ ?>
  ...
  */ ?>
	...
	<main>
		...
		<article>
			<header>
				<h1>Digital Communication Topics</h1>
				<ul>
					<li><a href="/wifi-wimax-lte/digital-com/principles-of-digital-communication.php">Introduction</a></li>
					<li><a href="/wifi-wimax-lte/digital-com/modulation.php">Modulation</a></li>
					<li><a href="/wifi-wimax-lte/digital-com/multiplexing.php">Multiplexing</a></li>
					<li><a href="/wifi-wimax-lte/digital-com/noise-and-error-correction.php">Noise and Error Correction</a></li>
				</ul>
			</header>
			<footer>
