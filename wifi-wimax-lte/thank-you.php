...
*/ ?>
  ...
  */ ?>
	...
	<main>
	<header>
		<h1>Wi-Fi,WiMAX &amp; LTE Learning Aid : Confirmation</h1>
		<?php /*** Optional header - only applicable when more than one article one page */ ?>
	</header>

	<h1> Thank you </h1>
	<p> for email, we will endeavour to get back to as soon as possible.</p>
		<footer>
  ...
  */ ?>
	<footer id="pageFooter">
		<ul id="pageFooterNav">
			<li>
				<a href="<?php echo $wifiWimaxLte; ?>">
					Home<span class="fa fa-home"></span>
				</a>
			</li>
			<li>
				<a href="<?php echo $wifiWimaxLte; ?>support/contact.php">
