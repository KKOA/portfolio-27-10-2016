...
<?php require_once "../../includes/nav.php" ?>
  ...
  */ ?>
  ...
  <main>
  	<header>
      <h1>Wi-Fi,WiMAX &amp; LTE Learning Aid : LTE</h1> <?php /*** Optional header - only applicable when more than one article one page */ ?>
    </header>
    <!--<p><a>Breadcrumbs</a></p>-->
    ...
    <article>
        <header>
        	<h1>LTE Topics</h1>
			<ul>
			<li><a href="/wifi-wimax-lte/lte/lte-history.php">LTE History</a></li>
      <li><a href="/wifi-wimax-lte/lte/lte.php">LTE</a></li>
      <li><a href="/wifi-wimax-lte/lte/lte-advanced.php">LTE Advanced</a></li>
	  <li><a href="/wifi-wimax-lte/lte/implementation-of-lte-and-4g.php">Implementation of LTE and 4G</a></li>
      <li><a href="/wifi-wimax-lte/lte/lte-test.php">LTE Tests</a></li>
	  <li><a href="/wifi-wimax-lte/lte/lte-conclusion.php">LTE Conclusion</a></li>
			</ul>
