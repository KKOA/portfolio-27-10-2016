	...
	<main>
		...
		<article>
			<header>
				...
				<ul>
					<li><a href="/wifi-wimax-lte/support/contact.php">Contact</a></li>
					<li><a href="/wifi-wimax-lte/support/faqs.php">FAQs</a></li>
					<li><a href="/wifi-wimax-lte/support/abbreviations.php">Abbreviations</a></li>
				</ul>
			</header>
			<footer>
