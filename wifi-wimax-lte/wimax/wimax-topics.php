	...
	<main>
		...
		<article>
			<header>
				<h1>WiMAX Topics</h1>
				<ul>
					<li><a href="/wifi-wimax-lte/wimax/wimax.php">WiMAX</a></li>
					<li><a href="/wifi-wimax-lte/wimax/mobile-wimax.php">Mobile WiMAX</a></li>
					<li><a href="/wifi-wimax-lte/wimax/future-wimax.php">Future WiMAX</a></li>
				</ul>
			</header>
			<footer>
